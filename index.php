...
require_once(__ROOT__.'/iroportfolio/header.php'); 
?> 
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end">
          ...
          <div class="col-md-12 text-center ftco-animate">
            <!-- <h1 class="mt-5" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">Quero<br>Labor</h1> -->
            <!-- <h1 class="mt-5" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">Puedo<br>Servir</h1> -->
            <h1 class="mt-5" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">I Will<br>Work</h1>
            <!-- <h2>In Spanish... cause I'm bi-lingual</h2> -->
            <!-- <h2>Yeah!</h2> -->
            <!-- <h2>For honor ...and the american way</h2> -->
            <!-- <h2>For honor... yup... that's the ticket</h2> -->
            <!-- <h2>For food ? No wait... that's stupid... not for food</h2> -->
            <!-- <h2>My ass off to get your audience to engage</h2> -->
            <!-- <h2>To make your brand bigger and better</h2> -->
            <!-- <h2>To help you grow your business</h2> -->
            <!-- <h2>To get your product and message out</h2> -->
            <h2>For you and your company</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-3">Fulltime or Freelance</h2>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-3">Previous & Recent Work</h2>
    ...
    <section class="ftco-section testimony-section" style="background-image: url(images/bg_4.jpg);" data-stellar-background-ratio="0.5">
    	<div class="overlay"></div>
      <div class="container">
				<div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-md-5">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">App Dev</a></li>
                <li><a href="#" class="py-2 d-block">Graphic Design</a></li>
                <li><a href="#" class="py-2 d-block">Social Mgmnt</a></li>
                <li><a href="#" class="py-2 d-block">Content Writing</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+1 787 307-0710</span></a></li>
