...
?> 
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end">
          <div class="col-md-12 text-center ftco-animate">
            <h1 class="mb-3 bread" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">What I Do</h1>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div>
  				<p>A year ago I came back from Brasil. Back to my home of Puerto Rico. I had lived in PR up until the ripe age of 24, when I moved to Florida. Originally, I had gone to Miami to get my masters in Graphic Design, however, I quickly realized that getting a graduate degree in that field wasn't really going to make much more of a difference than the Bachelor's I already had. Back then (2004), anything with computers (and I mean anything) was considered among the echelon of careers of choice; graphic design being one of the ones with the best forecast for making a good living. -- INSERT JOKE HERE --</p>

  				<p>So I quit school (a pretty expensive one at that) and went to work for any and all who would hire me. Most where part-time gigs (waiter, hotel cleaning crew, warehouse crew). I stayed in Miami for 6 yrs</p>
  			</div>
    	</div>
    </section>
